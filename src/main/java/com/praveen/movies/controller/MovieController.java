package com.praveen.movies.controller;

import com.praveen.movies.model.Movie;
import com.praveen.movies.service.MovieService;
...
public class MovieController {
    ...
    public ResponseEntity<Optional<Movie>> getSingleMovie(@PathVariable ObjectId id){
        ...
        return  new ResponseEntity<>(movieService.singleMovie(id),HttpStatus.FOUND);
    }
